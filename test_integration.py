...
print(f"💬 Question: {q1}")
print(f"🤖 Advisor:\n{process_student_query(q1, mock_profile_new)}\n")
print("-" * 50)

# Test Case 2: Downstream Block Impact
q2 = "What happens if I drop or fail ECEg4105?"
print(f"💬 Question: {q2}")
print(f"🤖 Advisor:\n{process_student_query(q2, mock_profile_active)}\n")
print("-" * 50)
...
print(f"💬 Question: {q3}")
print(f"🤖 Advisor:\n{process_student_query(q3, mock_profile_active)}\n")
print("-" * 50)